...
board=[["x","x","x","x","x","x","x","x","x"],["x","x","x","x","x","x","x","x","x"],["x","x","x","x","x","x","x","x","x"],["x","x","x","x","x","x","x","x","x"],["x","x","x","x","x","x","x","x","x"],["x","x","x","x","x","x","x","x","x"],["x","x","x","x","x","x","x","x","x"],["x","x","x","x","x","x","x","x","x"],["x","x","x","x","x","x","x","x","x"]]
...
for y1 in range(9):
    for x1 in range(9):
        pyautogui.moveTo(x+x1*50, y+y1*50)
        for i in range(2):
            pyautogui.mouseDown();
            pyautogui.mouseUp();
        image = ImageGrab.grab(bbox=(978+x1*50, 363+y1*50, 978+x1*50+1, 363+y1*50+1))
        rgb_im = image.convert('RGB')
        r, g, b = rgb_im.getpixel((0, 0))
        if r==0 and g==120 and b==215:
...
for y1 in range(9):
    for x1 in range(9):
        ...
        pyautogui.mouseDown();
        pyautogui.mouseUp();
        pyautogui.typewrite(board[y1][x1])
